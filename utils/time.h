...
#define PrintTimer(str,i) if(get_worker_id()==MASTER_RANK) printf("%s : %f seconds\n", (str), get_timer((i)));
...
enum TIMERS{WORKER_TIMER=0, SERIALIZATION_TIMER=1, TRANSFER_TIMER=2, COMMUNICATION_TIMER=3};
